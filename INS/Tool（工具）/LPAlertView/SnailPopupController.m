...
#ifndef __OPTIMIZE__
#define snNSLog(...) NSLog(__VA_ARGS__)
#else
#define snNSLog(...) {}
#endif
    ...
    if (_contentView.superview != _popupView) {
        ...
        if (_contentView.layer.cornerRadius > 0) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                roundRectLayer.bounds = weakSelf.popupView.layer.bounds;
                roundRectLayer.frame  = weakSelf.popupView.layer.bounds;
                UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:weakSelf.popupView.layer.bounds cornerRadius:weakSelf.contentView.layer.cornerRadius];
                roundRectLayer.path = path.CGPath;
                Dispatch_main_sync_safe(^{
                    weakSelf.popupView.clipsToBounds = NO;
                });
    ...
    if (isElasticAnimated) {
             ...
             usingSpringWithDamping:0.6
              initialSpringVelocity:0.2
                         ...
                         animations:^{
                             ...
                             [weakSelf dropAnimatedFinished];
                             [weakSelf maskAlphaFinished];
                             weakSelf.popupView.center = [weakSelf finishedCenterPoint];
        ...
        [UIView animateWithDuration:duration
                         ...
                         animations:^{
                             ...
                             weakSelf.popupView.center = [self finishedCenterPoint];
    ...
    if (isElasticAnimated) {
        ...
        [UIView animateWithDuration:duration1
                         ...
                         animations:^{
                             ...
                             weakSelf.popupView.center = [self elasticSpacePoint:30];
                             ...
                             [UIView animateWithDuration:duration2
                                              ...
                                              animations:^{
                                                  ...
                                                  [weakSelf dropAnimatedDismissed];
                                                  [weakSelf maskAlphaInitial];
                                                  weakSelf.popupView.center = [weakSelf dismissedCenterPoint];
        ...
        [UIView animateWithDuration:duration
                         ...
                         animations:^{
                             ...
                             [weakSelf dropAnimatedDismissed];
                             [weakSelf maskAlphaInitial];
                             weakSelf.popupView.center = [self dismissedCenterPoint];
